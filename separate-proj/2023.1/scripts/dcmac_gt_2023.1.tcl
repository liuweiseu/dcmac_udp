...
proc create_hier_cell_dcmac_0_gt_wrapper { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 -type gt_usrclk IBUFDS_ODIV2
  ...
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M2 [get_bd_intf_pins gt_quad_base/APB3_INTF] [get_bd_intf_pins axi_apb_bridge_0/APB_M2]
  ...
  connect_bd_net -net bufg_gt_0_usrclk [get_bd_pins bufg_gt_0/usrclk] [get_bd_pins IBUFDS_ODIV2]
  ...
  connect_bd_net -net ch0_txmaincursor_0_1 [get_bd_pins gt0_ch01_txmaincursor] [get_bd_pins gt_quad_base/ch0_txmaincursor] [get_bd_pins gt_quad_base/ch1_txmaincursor]
  connect_bd_net -net ch0_txpostcursor_0_1 [get_bd_pins gt0_ch01_txpostcursor] [get_bd_pins gt_quad_base/ch0_txpostcursor] [get_bd_pins gt_quad_base/ch1_txpostcursor]
  connect_bd_net -net ch0_txprecursor2_0_1 [get_bd_pins gt0_ch01_txprecursor2] [get_bd_pins gt_quad_base/ch0_txprecursor2] [get_bd_pins gt_quad_base/ch1_txprecursor2]
  connect_bd_net -net ch0_txprecursor3_0_1 [get_bd_pins gt0_ch01_txprecursor3] [get_bd_pins gt_quad_base/ch0_txprecursor3] [get_bd_pins gt_quad_base/ch1_txprecursor3]
  connect_bd_net -net ch0_txprecursor_0_1 [get_bd_pins gt0_ch01_txprecursor] [get_bd_pins gt_quad_base/ch0_txprecursor] [get_bd_pins gt_quad_base/ch1_txprecursor]
  ...
  connect_bd_net -net ch1_txmaincursor_0_1 [get_bd_pins gt1_ch01_txmaincursor] [get_bd_pins gt_quad_base_1/ch1_txmaincursor] [get_bd_pins gt_quad_base_1/ch0_txmaincursor]
  connect_bd_net -net ch1_txpostcursor_0_1 [get_bd_pins gt1_ch01_txpostcursor] [get_bd_pins gt_quad_base_1/ch1_txpostcursor] [get_bd_pins gt_quad_base_1/ch0_txpostcursor]
  connect_bd_net -net ch1_txprecursor2_0_1 [get_bd_pins gt1_ch01_txprecursor2] [get_bd_pins gt_quad_base_1/ch1_txprecursor2] [get_bd_pins gt_quad_base_1/ch0_txprecursor2]
  connect_bd_net -net ch1_txprecursor3_0_1 [get_bd_pins gt1_ch01_txprecursor3] [get_bd_pins gt_quad_base_1/ch1_txprecursor3] [get_bd_pins gt_quad_base_1/ch0_txprecursor3]
  connect_bd_net -net ch1_txprecursor_0_1 [get_bd_pins gt1_ch01_txprecursor] [get_bd_pins gt_quad_base_1/ch1_txprecursor] [get_bd_pins gt_quad_base_1/ch0_txprecursor]
  ...
  connect_bd_net -net util_ds_buf_1_IBUFDS_GTME5_ODIV2 [get_bd_pins util_ds_buf_1/IBUFDS_GTME5_ODIV2] [get_bd_pins bufg_gt_0/outclk]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins util_ds_buf_0/IBUFDS_GTME5_CEB] [get_bd_pins util_ds_buf_1/IBUFDS_GTME5_CEB]
...
proc create_root_design { parentCell } {
  ...
  set IBUFDS_ODIV2 [ create_bd_port -dir O -from 0 -to 0 -type gt_usrclk IBUFDS_ODIV2 ]
  ...
  set tx_core_clk [ create_bd_port -dir I -type gt_usrclk tx_core_clk ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {781250000} \
 ] $tx_core_clk
  set rx_core_clk [ create_bd_port -dir I -type gt_usrclk rx_core_clk ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {781250000} \
 ] $rx_core_clk
  set tx_serdes_clk [ create_bd_port -dir I -from 5 -to 0 -type clk tx_serdes_clk ]
  ...
  set dcmac_0_core [ create_bd_cell -type ip -vlnv xilinx.com:ip:dcmac:2.2 dcmac_0_core ]
  set_property -dict [list \
    CONFIG.DCMAC_CONFIGURATION_TYPE {Static Configuration} \
    CONFIG.DCMAC_DATA_PATH_INTERFACE_C0 {391MHz Upto 6 Ports} \
    CONFIG.DCMAC_LOCATION_C0 {DCMAC_X1Y5} \
    ...
    CONFIG.NUM_GT_CHANNELS {0} \
    CONFIG.PHY_OPERATING_MODE_C0 {FEC Only} \
  ...
  connect_bd_net -net g1_ch01_txprecursor_0_1 [get_bd_ports gt1_ch01_txprecursor] [get_bd_pins dcmac_0_gt_wrapper/gt1_ch01_txprecursor]
  ...
  connect_bd_net -net gt1_ch01_txmaincursor_1_1 [get_bd_ports gt1_ch01_txmaincursor] [get_bd_pins dcmac_0_gt_wrapper/gt1_ch01_txmaincursor]
  connect_bd_net -net gt1_ch01_txpostcursor_1_1 [get_bd_ports gt1_ch01_txpostcursor] [get_bd_pins dcmac_0_gt_wrapper/gt1_ch01_txpostcursor]
  ...
  connect_bd_net -net gt1_ch23_txprecursor2_1_1 [get_bd_ports gt1_ch23_txprecursor2] [get_bd_pins dcmac_0_gt_wrapper/gt1_ch23_txprecursor2]
  ...
  assign_bd_address -offset 0xA4C00000 -range 0x00080000 -target_address_space [get_bd_addr_spaces s_axi] [get_bd_addr_segs dcmac_0_core/s_axi/Reg] -force
