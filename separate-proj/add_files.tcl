...
set files [list \
 ...
 [file normalize "${origin_dir}/fourhundred_gbe/kutleng_skarab2_bsp_firmware/casperbsp/sources/vhdl/rtl/lbustoaxis/mapaxisdatatolbus.vhd"] \
 [file normalize "${origin_dir}/fourhundred_gbe/fhg_axis_adapter.v"] \
